...
![img_9.png](https://github.com/Hikari0727/cvat/blob/main/cvat/img_9.png)

或者，如果标注任务要添加到已经存在的项目中，可以直接从项目页面创建。

![img_10.png](https://github.com/Hikari0727/cvat/blob/main/cvat/img_10.png)

接下来，在任务配置窗口中填写必填字段。

![img_11.png](https://github.com/Hikari0727/cvat/blob/main/cvat/img_11.png)

上传文件有几种方法，其中一种是从电脑上上传文件。

![img_12.png](https://github.com/Hikari0727/cvat/blob/main/cvat/img_12.png)

任务可分为多个子任务，为此，您需要在高级配置部分选择一个子任务中包含的图像数量（分类大小）。

![img_13.png](https://github.com/Hikari0727/cvat/blob/main/cvat/img_13.png)

创建的任务如下：

![img_14.png](https://github.com/Hikari0727/cvat/blob/main/cvat/img_14.png)
...
![img_15.png](https://github.com/Hikari0727/cvat/blob/main/cvat/img_15.png)

![img_16.png](https://github.com/Hikari0727/cvat/blob/main/cvat/img_16.png)

对于分割任务，适合使用标记变体--多边形选择。为此，请按下以下按钮，然后选择 “shape”。

!![img_17.png](https://github.com/Hikari0727/cvat/blob/main/cvat/img_17.png)

![img_18.png](https://github.com/Hikari0727/cvat/blob/main/cvat/img_18.png)

其他标记类型的示例可在 CVAT 官方文档中找到。

如果要修改当前的标记，需要用 pcm 点击它，然后选择新的标记。

![img_19.png](https://github.com/Hikari0727/cvat/blob/main/cvat/img_19.png)

在 “Objects ”侧边栏中，您可以看到当前帧中可用对象的列表。下图是该列表的示例：

![img_20.png](https://github.com/Hikari0727/cvat/blob/main/cvat/img_20.png)

要查看任务的详细信息，您需要点击右上角的信息按钮。

![img_21.png](https://github.com/Hikari0727/cvat/blob/main/cvat/img_21.png)

弹出窗口将显示每种类型标签的数量信息。

![img_22.png](https://github.com/Hikari0727/cvat/blob/main/cvat/img_22.png)
...
1. 要导出最新标签，必须先保存所有更改。
    ...
    ![img_23.png](https://github.com/Hikari0727/cvat/blob/main/cvat/img_23.png)
    
2. 然后按下菜单按钮。任务和项目数据集的导出和导入可通过操作菜单完成。
3. 按下导出任务数据集按钮。
    
    ![img_24.png](https://github.com/Hikari0727/cvat/blob/main/cvat/img_24.png)
...
![img_25.png](https://github.com/Hikari0727/cvat/blob/main/cvat/img_25.png)
...
4. 将文件拖到文件上传区域，或单击上传区域在资源管理器中选择文件。
    ...
    ![img_26.png](https://github.com/Hikari0727/cvat/blob/main/cvat/img_26.png)
...
![img_27.png](https://github.com/Hikari0727/cvat/blob/main/cvat/img_27.png)

![img_28.png](https://github.com/Hikari0727/cvat/blob/main/cvat/img_28.png)

# 创建组织

要允许多个用户访问同一个项目，可以创建一个新的组织。要创建组织，请打开用户菜单，转到组织并单击“Create”。

![img_29.png](https://github.com/Hikari0727/cvat/blob/main/cvat/img_29.png)

填写创建组织所需的信息。您需要输入组织的简短名称，该名称将显示在菜单中。您还可以输入其他字段： 全名、描述和组织联系人。这些信息将在组织设置页面上显示。

![img_30.png](https://github.com/Hikari0727/cvat/blob/main/cvat/img_30.png)

要访问 “组织 ”页面，请打开用户菜单，转到 “组织 ”并单击 “设置”。

![img_31.png](https://github.com/Hikari0727/cvat/blob/main/cvat/img_31.png)
...
![img_32.png](https://github.com/Hikari0727/cvat/blob/main/cvat/img_32.png)

在组织内创建的项目中，用户可以被分配到特定的任务和子任务中。

![img_33.png](https://github.com/Hikari0727/cvat/blob/main/cvat/img_33.png)
